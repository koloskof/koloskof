...
11:T8fc,<h1>Подзапросы</h1>
<hr>
<h3>Подзапрос в <code>SELECT</code></h3>
...
<h3>Подзапрос в <code>FROM</code></h3>
<p>Структура запроса:</p>
<pre><code class="language-sql">SELECT 
	column_1
FROM (SELECT ... )
...
<h3>Подзапрос в <code>JOIN</code></h3>
<p>Структура запроса:</p>
<pre><code class="language-sql">SELECT 
	column_1,
	column_2
...
<h3>Подзапрос в <code>WHERE IN/NOT IN</code></h3>
<p>Структура запроса:</p>
<pre><code class="language-sql">SELECT 
	column_1
FROM table_name
...
<h3>Подзапрос в <code>WHERE &#x3C;></code></h3>
<p>Структура запроса:</p>
<pre><code class="language-sql">SELECT 
	column_1
FROM table_name
