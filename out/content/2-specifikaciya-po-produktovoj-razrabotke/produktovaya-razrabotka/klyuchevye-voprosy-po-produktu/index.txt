...
11:T6d1,<h1>Ключевые вопросы по продукту?</h1>
<h2>Продукт</h2>
<h3>Формат</h3>
<ul>
<li>Спецификация</li>
...
<ul>
<li>Какую проблему вы решаете (Пункты)?</li>
<li>Кто ваши клиенты (Категория пользователей)?</li>
<li>Как ваш продукт поможет решить их проблему (Аргумент);</li>
<li>Чем отличается от других продуктов представленных на рынке? (Аналитическая информация)?</li>
<li>Как ваш продукт будет поставляться на рынок? (Маркетинг / Каналы продаж).</li>
</ul>
<h2>Пользовательский опыт</h2>
<h3>Формат</h3>
<ul>
<li>Канвас / Объектная модель</li>
</ul>
<h3>Основные вопросы</h3>
<ul>
<li>Как пользователи будут на самом деле решать свои проблемы?</li>
<li>Какие у них цели?</li>
<li>Какие предубеждения у них  существуют?</li>
<li>Ключевые сченарии</li>
</ul>
<h2>Прототип</h2>
<h3>Формат</h3>
<p>Прототип / Библиотека компонент</p>
<h3>Основные вопросы</h3>
<ul>
<li>На что следует обратить внимание пользователей?</li>
<li>Что для них наиболее важно?</li>
<li>Какие эмоции мы хотим вызвать?</li>
<li>Что мы хотим чтобы пользователи почувствовали?</li>
</ul>
