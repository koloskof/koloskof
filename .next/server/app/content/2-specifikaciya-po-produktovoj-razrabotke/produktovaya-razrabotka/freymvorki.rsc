...
11:T898,<h1>Фреймворки</h1>
<h2>Frameworks</h2>
<ul>
<li>Design Thinking</li>
<li>Jobs To Be Done</li>
<li>Lean UX</li>
<li>Full process approach to solving design problems</li>
<li>Процесс тестирования гипотез</li>
<li>Основные инструменты привлечение трафика</li>
</ul>
...
<p>«Большинство компаний делят свою целевую аудиторию на сегменты по пользовательским или продуктовым характеристикам. Но у пользователя другой взгляд на рынок. У него просто есть задача, которую надо выполнить (job to be done), и он ищет лучший продукт, который поможет ему в этом»</p>
<h2>Lean UX</h2>
<ul>
<li>Понимаем целевой аудитории и ее проблемы</li>
<li>Создаем MVP (Minimum Viable Product — минимально жизнеспособный продукт)</li>
<li>Работаем короткими итерациями</li>
<li>Постоянное тестирование нововведений на пользователях и, если что-то не так, быстро откатываемся</li>
</ul>
<h2>Full-process approach to solving design problems</h2>
<ul>
<li>User research</li>
<li>Story map</li>
<li>Product experience matrix</li>
<li>Wireframes</li>
<li>Prototypes</li>
...
<h2>Процесс тестирования гипотез</h2>
<ul>
<li>Customer Development</li>
<li>UX тестирование</li>
<li>Математическое моделирование</li>
<li>А/B тестирование</li>
</ul>
<h2>Основные инструменты привлечения трафика</h2>
<p>Example: <a href="http://sequoiacreativelab.com/">http://sequoiacreativelab.com</a></p>
