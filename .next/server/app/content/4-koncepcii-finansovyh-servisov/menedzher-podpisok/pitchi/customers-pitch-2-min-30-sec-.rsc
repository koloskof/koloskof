...
11:T91d,<h1>Customers Pitch (2 min 30 sec)</h1>
<h3>Какие проблемы существуют на рынке?</h3>
<p>Бесконтрольное снятие денег за подписки</p>
<h3>У кого возникают подобные проблемы?</h3>
<ol>
<li>
<p>У людей которые хотят экономить время [автоматизирующие бытовую рутину];</p>
</li>
<li>
<p>У людей которые хотят рационально потреблять.</p>
</li>
</ol>
<h3>Какие способы решения этих проблем вы можете предложить?</h3>
<ol>
<li>
<p>Видеть все оформленные подписки</p>
</li>
<li>
<p>Остановить или поставить на паузу подписки</p>
</li>
<li>
...
<ul>
<li>Безопасного оформления подписок за счёт автоматического открытия отдельной виртуальной карты</li>
<li>Динамический подбор скидок в момент оплаты</li>
<li>Контроль за всеми подписками в одном месте</li>
<li>Умные рекомендации по оптимизации расходов за счёт подбора подписок</li>
</ul>
<h3>Процесс онбординга</h3>
<ul>
<li>Поставить расширение в браузер или мобильное приложение</li>
<li>Привязать свою карту</li>
<li>Перейти на сервис для оформления подписки</li>
<li>Ввести сгенерированный номер карты</li>
<li>Управление подписками из расширения/приложениями</li>
</ul>
<h3>Сколько это будет стоить?</h3>
<p>Примерно 199 рублей в месяц</p>
<h3>Как это решает их персональную проблему?</h3>
<ul>
<li>Предостерегает от потери денег</li>
<li>Позволяет экономить</li>
<li>Позволяет моментально оформлять по</li>
</ul>
