...
11:T873,<h1>Action plan</h1>
<h3>0 этап (Трекер подписок)</h3>
<ul>
<li>Авторизация;</li>
<li>Снипеты карточек сервисов под каждую категорию (Музыка/Еда/Транспорт/Одежда/Аренда/…);</li>
<li>Режим добавления и редактирования подписки;</li>
<li>Блок пользователя с настройками.</li>
</ul>
<h3>1 этап (Подписка на цифровые товары)</h3>
<ul>
<li>Chrome Extension, который в момент подписки предлагает оплатить виртуальной картой Opencharge и заводит подписку в приложение;</li>
<li>Подписка, которая заводится в приложении и подставляет данные (номер карты) в браузере;</li>
<li>Предлагает открыть подписку перед событием Netflix (выходом фильма Игра пристолов) / Яндекс Музыки перед релизом альбома.</li>
</ul>
<h3>2 этап (Скидка при покупке через Openchareg)</h3>
<ul>
<li>Оформление подписки на физическме товары с поиском скидки от Opencharge (скидка по умолчанию + перебор купонов)</li>
</ul>
<h3>3 этап (Сo-Branding + Opencharge)</h3>
<p>На основе аналитики частотных покупок выпуск Opencharge подписок на производственных мощностях сервисов по гайдам Opencharge</p>
<ul>
<li>Butnorton/OhMy/ + Opencharge</li>
<li>Буше/Теремок/SuchiShop + Opencharge</li>
</ul>
<h3>Точки входа</h3>
<ul>
<li>Подписка заведённая в момент оформления (через браузерный плагин)</li>
<li>Подписка заведённая заранее в мобильном приложении (со сгенерённой виртуалкой и лимитом)</li>
</ul>
