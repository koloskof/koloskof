...
11:T80b,<h1>Вопросы</h1>
<h3>На кого предназначен наш сервис?</h3>
<p>Мы поставляем финансовые модули в нео-банки и клиентские сервисы.</p>
<ul>
...
<h3><strong>Какую проблему мы решаем?</strong></h3>
<ul>
<li>Высокий порог входа и долгий процесс (низний time-to-market);</li>
<li>Неконсистентные решения сломанный пользователький опыт (низкий retention);</li>
<li>Высокие комиссии за поставляемую финансовую инфраструктуру;</li>
<li>Не достаточно отлаженная инфраструктура для масштабирования (низкий growth).</li>
</ul>
<h3>Какую задачу решают финансовые модули?</h3>
<p>Повысить эффективность [частотность и средний чек] сделок и прозрачность [предсказуемость] деловых отношений между (людьми — компаниями — производством)  используя все преимущества цифровой среды.</p>
<h3>Какие показатели эфективности</h3>
<ul>
<li>Скорость проектирования новой версии;</li>
<li>Простота кастомизации;</li>
<li>Лёгкость масштабирования.</li>
</ul>
<h3><strong>Как использование наших модулей помогает бизнесу?</strong></h3>
<ul>
<li>Помогаяем быстрей получить первый проототип для проверки гипотез;</li>
<li>Помогаем качествено масштабировать сервис.</li>
</ul>
