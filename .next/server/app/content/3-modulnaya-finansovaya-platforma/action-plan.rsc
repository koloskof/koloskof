...
11:T740,<h1>Action Plan</h1>
<h3>Спецификация</h3>
<p>Собрать максимальный уровень экспертизы по ключевой финтех функциональности и упаковать его в спецификацию. На основе которой сделать курс, который помогает проще погрузиться в предметную область.</p>
<p>На примере <a href="https://openuni.io/course/7-course-6/">https://openuni.io/course/7-course-6/</a></p>
<h2>Fintech components</h2>
<p>Собрать компонентную структуру по ключевым финансовым направлениям для последующей оперативной сборки прототипов целевых продуктов</p>
<ul>
<li>[ ]  Авторизация, Идентификация, Профиль (Настройки)</li>
<li>[ ]  Менеджмент расходов</li>
<li>[ ]  Каталог товаров и услуг</li>
<li>[ ]  Системы лояльности</li>
<li>[ ]  Счета и Банковские карты</li>
<li>[ ]  Платежи и Переводы</li>
</ul>
<h2>Прототип розничного банка</h2>
<ul>
<li>[ ]  Собрать работающий прототип ритеил банка с ключевыми продуктами.</li>
</ul>
<h2>Financial Services Operation System</h2>
<p>Операционная система для раскатки основы для проектирования и поставки финансовых продуктов (платформа для банков).</p>
<p>Пример:
<a href="https://11fs.com/products/11fs-foundry">https://11fs.com/products/11fs-foundry</a>
<a href="https://www.intuit.com/">https://www.intuit.com/</a></p>
